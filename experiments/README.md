...
| [#413](https://github.com/labtgbot/telegram-claude-agent/issues/413) Guest Mode HTML без `parse_mode` | P2 | ★ `exp_proxy_guest_html_plaintext.py`, `exp_proxy_guest_routing.py` |
